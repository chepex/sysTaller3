...
@ManagedBean(name = "repuestoController")
@SessionScoped
public class RepuestoController implements Serializable {

    @EJB
    private com.entities.RepuestoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("RepuestoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("RepuestoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("RepuestoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class RepuestoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Repuesto) {
                ...
                return getStringKey(o.getIdRepuesto());
            } else {
